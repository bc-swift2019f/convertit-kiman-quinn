...
//  ConvertIt
//
//  Created by Kim-An Quinn on 9/25/19.
...
class ViewController: UIViewController {
    ...
    func calculateConversion(){
        ...
        case "liters to quarts":
            outputValue = inputValue * 1.05669
        default:
            showAlert(title: "unexpected error", message: "Contact the developer, share that the \(conversionString) could not be identified.")
        }
...
extension ViewController: UIPickerViewDelegate, UIPickerViewDataSource{
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        //will be true regardless of case but both are "celsius"
